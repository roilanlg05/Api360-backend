...
from app.schemas.schemas import Airport  # por ejemplo

# 📌 Ruta al CSV (ajusta según dónde lo tengas)
CSV_PATH = Path("UPPLY-AIRPORTS.csv")

# 📌 URL de tu base de datos (cámbiala por la real)
DATABASE_URL = "postgresql+psycopg2://hashdown:Rlg*020305@localhost:5433/api360"
